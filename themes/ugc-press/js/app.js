  ...
  shb_reveal_closer_today_button.length > 0 && shb_reveal_closer_today_button.on("click", function() {
    localStorage.setItem("shb_close_today", "true"), localStorage.setItem("shb_close_today_date", new Date)
  });
...
if(isMobile == true) {
  ...
  if(document.body.classList.contains('home')) {
    $('.homepage-link').click(function(){
      $('#main-nav-drawer').css('display','none');
      console.log('click');
    })
  }
}
...
//         var input = document.getElementById("secretPassword");
//         var inputRegister = document.getElementById("secretPasswordRegister");
